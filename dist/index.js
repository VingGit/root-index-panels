...
var RootIndexPanels_default = ((userOpts) => {
  ...
  const RootIndexPanels = ({ fileData, allFiles }) => {
    ...
    if (slug2 !== "index") return /* @__PURE__ */ u2(k, {});
...
export { ExampleComponent_default as ExampleComponent, ExampleEmitter, ExampleFilter, ExampleTransformer, RootIndexPanels_default as RootIndexPanels };
