  ...
  const RootIndexPanels = ({
    ...
    return /* @__PURE__ */ jsxs("article", { class: rootArticleClass(fileData, options.layout), children: [
      ...
      latestEntries.length > 0 && /* @__PURE__ */ jsxs("section", { class: "rip-latest", "aria-labelledby": "rip-latest-heading", children: [
        /* @__PURE__ */ jsx("div", { class: "rip-section-heading", children: /* @__PURE__ */ jsx("h2", { id: "rip-latest-heading", children: translation.latestBooks }) }),
        /* @__PURE__ */ jsx(
          BookCollection,
          {
      ...
      showRootContent && /* @__PURE__ */ jsx("div", { class: "rip-root-content markdown-preview-view markdown-rendered", children: htmlToJsx(tree) }),
...
var sidebar_inline_default = `var l="rip-sidebar-explorer-navigation",d=!1;function f(){try{return window.matchMedia?.("(max-width: 800px)").matches??window.innerWidth<=800}catch{return window.innerWidth<=800}}function p(){d=!0;try{window.sessionStorage?.setItem(l,"true")}catch{}}function m(){let t=!1;try{t=window.sessionStorage?.getItem(l)==="true",window.sessionStorage?.removeItem(l)}catch{}let o=d||t;return d=!1,o}function u(){let t=()=>{document.querySelector('.page[data-frame="default"] > #quartz-body > .center .markdown-preview-view.markdown-rendered > :first-child')?.scrollIntoView({behavior:"auto",block:"start"})};typeof window.requestAnimationFrame=="function"?window.requestAnimationFrame(()=>window.requestAnimationFrame(t)):window.setTimeout(t,0)}function w(t){let o=Array.from(document.querySelectorAll(".rip-sidebar .rip-sidebar-switcher"));for(let e of o){let i=()=>{if(e.open)for(let a of o)a!==e&&(a.open=!1)},r=a=>{a.target?.closest?.("a")&&(e.open=!1)};e.addEventListener("toggle",i),e.addEventListener("click",r),t.push(()=>{e.removeEventListener("toggle",i),e.removeEventListener("click",r)})}if(o.length===0)return;let n=e=>{let i=e.target;if(i)for(let r of o)r.open&&!r.contains(i)&&(r.open=!1)},s=e=>{if(e.key!=="Escape")return;let i=o.find(a=>a.open);if(!i)return;e.preventDefault(),i.open=!1,i.firstElementChild?.focus?.()};document.addEventListener("pointerdown",n),document.addEventListener("keydown",s),t.push(()=>{document.removeEventListener("pointerdown",n),document.removeEventListener("keydown",s)})}function g(t){let o=Array.from(document.querySelectorAll(".rip-sidebar [data-rip-disclosure]"));for(let n of o){let s=()=>{let e=n.getAttribute("aria-controls");if(!e)return;let i=document.getElementById(e),r=n.closest(".rip-sidebar-folder");if(!i||!r)return;let c=!(n.getAttribute("aria-expanded")==="true");n.setAttribute("aria-expanded",String(c)),i.hidden=!c,r.dataset.ripOpen=String(c)};n.addEventListener("click",s),t.push(()=>n.removeEventListener("click",s))}}function v(t){let o=Array.from(document.querySelectorAll(".rip-sidebar .rip-sidebar-explorer"));for(let n of o){let s=e=>{if(e.defaultPrevented||!f()||e.button!==0||e.altKey||e.ctrlKey||e.metaKey||e.shiftKey)return;let r=e.target?.closest?.("a");!r||!n.contains(r)||(n.open=!1,r.getAttribute("aria-current")==="page"?(e.preventDefault(),e.stopPropagation(),u()):p())};n.addEventListener("click",s),t.push(()=>n.removeEventListener("click",s))}m()&&(o.forEach(n=>{n.open=!1}),u())}function E(){let t=[];w(t),v(t),g(t),t.length>0&&typeof window<"u"&&window.addCleanup&&window.addCleanup(()=>t.forEach(o=>o()))}typeof document<"u"&&document.addEventListener("nav",()=>E());
`;
  ...
  const RootIndexSidebar = (props) => {
    ...
    return /* @__PURE__ */ jsx(
      "nav",
      {
        ...
        ...selectedBook ? panelAttributes2(selectedBook.panel, options) : {},
        children: /* @__PURE__ */ jsxs("div", { class: "rip-sidebar-content", children: [
          ...
          (scope.kind === "book" || scope.children.length > 0) && /* @__PURE__ */ jsx("section", { class: "rip-sidebar-scope", "aria-label": translation.explorer, children: /* @__PURE__ */ jsxs("details", { class: "rip-sidebar-explorer", open: true, children: [
            /* @__PURE__ */ jsx("summary", { class: "rip-sidebar-scope-title", children: /* @__PURE__ */ jsx("h2", { children: translation.explorer }) }),
...
var RootIndexPanelsPage = (userOptions) => {
  return {
    ...
    match: ({ slug: slug2, fileData }) => {
      return slug2 === "index" && isPhysicalRoot(fileData);
    },
    layout: "content",
